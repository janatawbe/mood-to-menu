...
/** Distinct from the true "nothing saved at all" empty state (Step 27) — shown only
 * when saved recipes exist but the current search/mood filter matches none of them. */
